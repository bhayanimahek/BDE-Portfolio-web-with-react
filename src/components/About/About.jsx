...
// import Reveal from "../Reveal"; // <-- Import the reusable animation wrapper
...
//           handling, I specialize in creating opportunities that drive sustainable
//           business growth.
//         </p>
//       </Reveal>
...
//             <p>
//               <strong>Business Development & Sales Expertise</strong> – Proven
//               record of driving revenue and client acquisition.
//             </p>
//           </div>
//         </Reveal>
...
//             <FaBriefcase className="highlight-icon" />
//             <p>
//               <strong>Technical Skills</strong> – Proficient in JavaScript, SQL,
...
//             <FaBriefcase className="highlight-icon" />
//             <p>
//               <strong>International Client Handling</strong> – Skilled in
//               managing US-region clients with effective communication.
//             </p>
//           </div>
//         </Reveal>
...
//             <p>
//               <strong>Certified Professional</strong> – Microsoft Career
//               Essentials in Data Analysis, IBM Project Management Fundamentals.
//             </p>
//           </div>
//         </Reveal>
//       </div>
...
//             <p>Bachelor’s in ICT – GTU (2026)</p>
//           </div>
//         </Reveal>
...
//           <div className="edu-card">
//             <FaGraduationCap className="edu-icon" />
//             <p>Diploma in Computer Engineering – GTU (2022)</p>
//           </div>
//         </Reveal>
...
//             <p>Microsoft Career Essentials in Data Analysis</p>
//           </div>
//         </Reveal>
...
//           <div className="edu-card">
//             <FaCertificate className="edu-icon" />
//             <p>IBM Project Management Fundamentals</p>
//           </div>
//         </Reveal>
//       </div>
...
//       {/* CTA Button */}
//       <Reveal direction="up" delay={0.2}>
//         <a href="../..assets/gunjal.pdf" download className="about-btn">
//           Download Resume
//         </a>
//       </Reveal>
